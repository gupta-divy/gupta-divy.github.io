...
excerpt: "To improve efficiency of a legged robot, in particular quadruped we ideated with using self-locking actuators for each joint to achieve static stability.<br/><img src='/images/Chitrak_Iteration_1.png'>"
